...
//     Customer(int userId, String email, String password, String firstName, String lastName, String city, String gender,
...
//                 "Customer [userId=%d, emailId=%s, password=%s, firstName=%s, lastName=%s, city=%s, gender=%s, phoneNumber=%d, address=%s]",
...
// abstract class BookRentalServiceImpl implements BookRentalService {
